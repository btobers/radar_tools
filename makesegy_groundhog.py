...
Michael S. Christoffersen, Brandon S. Tober
25 OCT2020
"""
### imports ###
import numpy as np
...
def main():
  ...
  datapfix = "F:/MARS/targ/xped/Ruth2022/radar/proc/co/"
  outpfix = "F:/MARS/targ/xped/Ruth2022/radar/proc/co/segy/"
  ...
  for id in ids:
    ...
    datafile = id + ".h5"
    outfile = id + ".sgy"
    paths.append((datapfix+datafile,outpfix+outfile))
